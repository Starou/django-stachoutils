...
class StorageTestCase(TestCase):
    ...
    def test_overwite_storage(self):
        ...
        with self.settings(MEDIA_ROOT=self.tmp_media_root):
            ...
            my_car.photo.save("some pic", ImageFile(open(os.path.join(old_media_root, "1st_Saab_9-3_SE.jpg"),
                                                         mode="rb")))
            ...
            my_car.photo.save("some pic", ImageFile(open(os.path.join(old_media_root, "Saab_9-3_Vector_sedan.jpg"),
                                                         mode="rb")))
            self.assertEqual(my_car.photo.name, u'cars/Saab_9.3_2.0t.jpg')
